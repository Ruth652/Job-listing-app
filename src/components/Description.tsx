...
export const Description = () => {
  ...
  const colorMap = ["text-[#FFB836]", "text-[#56CDAD]"];
  const borderMap = [
  ...
  return (
    <div className="flex p-3 gap-4 flex-row">
      ...
      <div className=" basis-2/7">
          ...
          <div>
            <div className="flex gap-2 mb-2">
              <div className="flex align-items-end pt-4">
                <img className="h-7  " src="/posted-on.png" alt="" />
              </div>
              <div>
                <p>Posted On</p>
            ...
            <div className="flex gap-2 mb-2 ">
              <div className="flex align-items-end pt-4">
                <img className="h-7  " src="/Start-Date.png" alt="" />
              </div>
              <div>
                <p>Start Date</p>
            ...
            <div className="flex gap-2 mb-2 ">
              <div className="flex align-items-end pt-4">
                <img className="h-7  " src="/End-Date.png" alt="" />
              </div>
              <div>
                <p>End Date</p>
        ...
        <div className="mb-3">
          <div className="font-extrabold">Required Skills</div>
          <div>
            {job.about.required_skills.map((c, ind) => (
              <button
                key={ind}
                className={
                  "  p-1 mr-1 mb-1 text-[#2D298E] bg-[#F8F8FD]  border border-blue-200"
                }
              >
                {c}
              </button>
